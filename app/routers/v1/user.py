...
from app.models.user import UseBase, Users, UserUpdate
...
async def create_user(user: UseBase, acls: list = Permission('admin', acl_roles)):
    ...
    try:       
        ...
        return success(user.dict(),  status_code=201)
...
async def update_user(user_id: int, user_data: UserUpdate, acls: list = Permission('admin', acl_roles)):
    ...
    try:
        ...
        return success(user.dict(exclude_unset=True))
